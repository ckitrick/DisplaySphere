...
BOOL read_bmp(char *fn, IMAGE *img)
{
...
int write_png_new(char *fn, void *bmfHeader, void *bi, void *pixelData)// IMAGE *img)
{
...
/* HERE IS WHERE ALL THE MAGIC HAPPENS
	Need to build image structure from raw BMP info
...
BOOL read_bmp2(char *fn, IMAGE *img)
{
	BYTE bfh[FILEHED_SIZE + BMPV5HED_SIZE];
	BYTE *const bih = bfh + FILEHED_SIZE;
	BYTE rgbq[RGBQUAD_SIZE];
